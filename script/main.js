'use strict';
{
  ...
  /* mysite section */
  const mysite_images = [
    'img/01_mediaNews.png',
    'img/06_MyProjects.png',
    'img/07_MurphysLaw.png',
    'img/08_Markdown2HTML.png',
    'img/09_AmiVoiceAPI.png',
  ];
  const mysite_urls = [
    "01_projects/01_mediaNews/index.html",
    "01_projects/06_MyProjects/index.html",
    "01_projects/07_MurphysLaw/index.html",
    "01_projects/08_Markdown2HTML/index.html",
    "01_projects/09_AmiVoiceAPI/index.html",
  ];
  let currentNum = 0;
